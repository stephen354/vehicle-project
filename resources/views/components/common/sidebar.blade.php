        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.svg"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">VEHICLE</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="/vehicle" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/approval" class="nav-link group">
                        <div class="flex items-center">
                        ...
                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Approval Process</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <a href="/vehicle-order" class="nav-link group">
                        <div class="flex items-center">
                        ...
                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Vehicle Order</span>
                        </div>
                    </a>
                </li>
                @endif
                ...
                <li class="menu nav-item">
                    <a href="/vehicle-usage" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Vehicle Usage</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="/log-approval" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Log Approval</span>
                        </div>
                    </a>
                </li>
            </ul>
